...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "www", "code", "3", "4",}, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    -- Rofimoji
    awful.key({altkey, }, " ", function() awful.spawn("rofimoji") end, 
              {description="rofimoji", group="thesmader"}),

    -- Brightness controls
    awful.key({}, "XF86MonBrightnessUp", function() awful.spawn("lux -a 5%") end, 
              {description="increase brightness", group="awesome"}),
    awful.key({}, "XF86MonBrightnessDown", function() awful.spawn("lux -s 5%") end, 
              {description="lower brightness", group="awesome"}),

    -- Screenshot
    awful.key({}, "Print", function() awful.util.spawn_with_shell("flameshot gui") end, 
              {description="launch flameshot", group="awesome"}),

    -- Media controls
    awful.key({}, "XF86AudioPlay", function() awful.spawn("playerctl play-pause")end, 
              {description="play/pause", group="awesome"}),
    awful.key({}, "XF86AudioNext", function() awful.spawn("playerctl next") end, 
              {description="next", group="awesome"}),
    awful.key({}, "XF86AudioPrev", function() awful.spawn("playerctl previous") end, 
              {description="previous", group="awesome"}),
...
-- AutoStart
awful.spawn.with_shell("/home/thesmader/scripts/polybarstart")
